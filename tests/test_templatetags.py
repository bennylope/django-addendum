...
class TagTests(TestCase):
    ...
    def setUp(self):
        self.plain_snippet = Snippet.objects.create(key="plain", text="Hello, humans")
        self.rich_snippet = Snippet.objects.create(
            key="rich", text="<h1>Hello, humans</h1>"
        )
        self.template_snippet = Snippet.objects.create(
            key="django", text="{{ dog|upper }}"
        )
        SnippetTranslation.objects.create(
            snippet=self.plain_snippet, language="es", text="Hola, humanos"
        )
        SnippetTranslation.objects.create(
            snippet=self.plain_snippet, language="en-au", text="G'day, humans"
        )

    def test_has_snippet(self):
        """Ensure that the saved snippet text is displayed"""
        t = Template(
            """{% load addendum_tags %}{% snippet 'plain' %}Hello world{% endsnippet %}"""
        )
        c = Context({})
        result = t.render(c)
    ...
    def test_no_snippet(self):
        ...
        t = Template(
            """{% load addendum_tags %}{% snippet 'missing' %}Hello world{% endsnippet %}"""
        )
        c = Context({})
        result = t.render(c)
    ...
    def test_plain_text(self):
        ...
        t = Template(
            """{% load addendum_tags %}{% snippet 'rich' %}Hello world{% endsnippet %}"""
        )
        c = Context({})
        result = t.render(c)
    ...
    def test_richtext(self):
        ...
        t = Template(
            """{% load addendum_tags %}{% snippet 'rich' richtext=True %}Hello world{% endsnippet %}"""
        )
        c = Context({})
        result = t.render(c)
        self.assertEqual(result, "<h1>Hello, humans</h1>")
    ...
    def test_safe(self):
        ...
        t = Template(
            """{% load addendum_tags %}{% snippet 'rich' safe=True %}Hello world{% endsnippet %}"""
        )
        c = Context({})
        result = t.render(c)
        self.assertEqual(result, "<h1>Hello, humans</h1>")
    ...
    def test_safe_false(self):
        ...
        t = Template(
            """{% load addendum_tags %}{% snippet 'rich' safe=isallowed %}Hello world{% endsnippet %}"""
        )
    ...
    def test_raw_template_text(self):
        ...
        t = Template(
            """{% load addendum_tags %}{% snippet 'django' %}Hello world{% endsnippet %}"""
        )
        c = Context({"dog": "woof"})
        result = t.render(c)
    ...
    def test_template_text(self):
        ...
        t = Template(
            """{% load addendum_tags %}{% snippet 'django' template=True %}Hello world{% endsnippet %}"""
        )
        c = Context({"dog": "woof"})
        result = t.render(c)
    ...
    def test_safe_template_text(self):
        ...
        t = Template(
            """{% load addendum_tags %}{% snippet 'django' template=True safe=True %}Hello world{% endsnippet %} {{ after }}"""
        )
    ...
    def test_template_error(self):
        ...
        t = Template(
            """{% load addendum_tags %}{% snippet 'bad' template=True %}Hello world{% endsnippet %}"""
        )
        c = Context({"dog": "woof"})
        result = t.render(c)
        self.assertEqual(result, "Hello world")
    ...
    def test_variable_key_name(self):
        ...
        t = Template(
            """{% load addendum_tags %}{% snippet snippetname %}Hello world{% endsnippet %}"""
        )
    ...
    def test_translate_basic(self):
        ...
        t = Template(
            """{% load addendum_tags %}{% snippet 'plain' language='es' %}Hello world{% endsnippet %}"""
        )
        c = Context({})
        result = t.render(c)
    ...
    def test_missing_translation(self):
        ...
        t = Template(
            """{% load addendum_tags %}{% snippet 'plain' language='es-mx' %}Hello world{% endsnippet %}"""
        )
        c = Context({})
        result = t.render(c)
        self.assertEqual(result, "Hello, humans")
    ...
    def test_specified_language(self):
        ...
        t = Template(
            """{% load addendum_tags %}{% snippet 'plain' language=lang safe=True %}Hello world{% endsnippet %}"""
        )
